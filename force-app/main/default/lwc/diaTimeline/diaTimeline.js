...
export default class DiaTimeline extends LightningElement {
    // config settings
    ...
    handleFilter(e) {
        const filteredData = this.template.querySelector('c-dia-timeline-filter').filterRecords(this.masterData);
