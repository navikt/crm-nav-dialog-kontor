...
export default class TimelineItem extends NavigationMixin(LightningElement) {
    ...
    get isExpandable() {
        return this.expandedFieldsToDisplay.length > 0 || this.isThread || this.isConvNote;
    }
    ...
    get sObjectKind() {
        return this.row?.record?.sObjectKind;
    }
    ...
    get isConvNote() {
        return this.sObjectKind === 'Conversation_Note__c';
    }
}
